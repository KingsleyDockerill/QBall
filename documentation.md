...
> Note: math requires a ; at the end, even if its the final line
...
But there is another way that costs a bit more efficiency with less code. Along with the builtin there is a keyword `input`. To use this use this
```
